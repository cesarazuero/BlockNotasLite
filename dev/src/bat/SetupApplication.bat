...
:: Android packaging
set AND_CERT_NAME="Block de Notas"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\BlockdeNotas.p12
...
set IOS_PROVISION=cert\BlockdeNotas.mobileprovision
...
set APP_ID=air.BlockdeNotas

:: Output packages
set DIST_PATH=dist
set DIST_NAME=BlockdeNotas
